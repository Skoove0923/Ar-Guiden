  ...
  <view class="login-container">
    <view class="login-card">
      <view class="card-header">
        ...
        <text class="subtitle">使用您的账号登录系统</text>
      </view>
      ...
      <uni-forms :model="formState" ref="form" class="login-form">
        ...
        <button class="login-btn" @click="onFinish">登 录</button>

        <view class="help-links">
          <text class="help-text" @click="toForget">忘记密码?</text>
...
const toForget = () => {
  uni.navigateTo({ url: '/pages/index/forget' });
}
